...
//Task 3.
// Представим себе ситуацию, что мы начали использовать данные объекты на странице и поняли что нам 
//не хватает изображения. Добавим свойство image в объект cpu. Поскольку, memory наследуется cpu 
//то данное свойство появится и у него. Просто дописываем данное свойство в cpu.
cpu["image"] = '';
